package net.richardlord.ash.test;

import static org.junit.Assert.assertEquals;
import net.richardlord.ash.core.Engine;
import net.richardlord.ash.test.mockups.MockBulletsComponent;
import net.richardlord.ash.test.mockups.MockFireSystem;
import net.richardlord.ash.test.mockups.MockGunEntity;
import net.richardlord.ash.test.mockups.MockPhysicsSystem;
import net.richardlord.ash.test.mockups.MockSpaceShipEntity;
